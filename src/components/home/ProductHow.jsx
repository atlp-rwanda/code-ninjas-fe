...
import HowTwo from '../../../static/productHowItWorks2.svg';
import HowThree from '../../../static/productHowItWorks3.svg';
        ...
        <div>
          <Grid container spacing={5}>
            <Grid item xs={12} md={4}>
              <Box sx={item}>
                <Box sx={number}>1.</Box>
                <Box component="img" src={HowOne} alt="suitcase" sx={image} />
            ...
            <Grid item xs={12} md={4}>
              <Box sx={item}>
                <Box sx={number}>2.</Box>
                <Box component="img" src={HowTwo} alt="graph" sx={image} />
                <Typography variant="h5" align="center">
            ...
            <Grid item xs={12} md={4}>
              <Box sx={item}>
                <Box sx={number}>3.</Box>
                <Box component="img" src={HowThree} alt="clock" sx={image} />
                <Typography variant="h5" align="center">
